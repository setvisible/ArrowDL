...
;Descriptions
    ...
    LangString DESC_SectionStartMenuShortcut ${LANG_ITALIAN} "Crea il gruppo programmi nel menu Start."
    LangString DESC_SectionDesktopShortcut ${LANG_ITALIAN} "Crea un collegamento programma sul desktop."
